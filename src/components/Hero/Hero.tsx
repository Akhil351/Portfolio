...
import { Github, Linkedin, Code2, Instagram, Twitter } from "lucide-react";
...
function TypewriterCycler() {
  ...
  return (
    <div className="flex items-center gap-2 min-h-[28px]">
      ...
      <span className="w-0.5 h-4 bg-cyan-400 cursor-blink inline-block" />
    </div>
  );
}
...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center overflow-hidden bg-[#020408]">
      {/* Scanline */}
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-[#020408]/70 via-transparent to-[#020408]/30 pointer-events-none" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 pt-24 pb-10 w-full">
        <div className="max-w-3xl">
          ...
          <motion.div
            ...
            className="mb-5"
          >
            <div className="text-gray-500 font-mono text-sm tracking-[0.25em] mb-2 uppercase">
              &lt; Vathaluru
            </div>
            ...
            <div className="text-gray-500 font-mono text-sm tracking-[0.25em] mt-2 uppercase text-right max-w-xs">
              /&gt;
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="mb-2"
          >
            <span className="text-gray-600 font-mono text-xs mr-2 tracking-wide">const role =</span>
            <TypewriterCycler />
          </motion.div>
          ...
          >
            <motion.button
              ...
              className="relative px-8 py-3.5 bg-cyan-400 text-[#020408] font-bold text-sm tracking-wide rounded-sm overflow-hidden group"
            ...
            <motion.button
              ...
              className="px-8 py-3.5 border border-gray-700 text-gray-300 text-sm font-medium rounded-sm hover:border-cyan-400/60 hover:text-white hover:bg-cyan-400/5 transition-all"
              whileHover={{ scale: 1.03, y: -2 }}
              whileTap={{ scale: 0.97 }}
            >
              Contact Me
            ...
            <div className="flex items-center gap-3 ml-2">
              {[
                { href: personalInfo.github, Icon: Github, color: "hover:text-white" },
                { href: personalInfo.linkedin, Icon: Linkedin, color: "hover:text-cyan-400" },
                { href: personalInfo.leetcode, Icon: Code2, color: "hover:text-orange-400" },
                { href: personalInfo.instagram, Icon: Instagram, color: "hover:text-pink-400" },
                { href: personalInfo.twitter, Icon: Twitter, color: "hover:text-sky-400" },
              ].map(({ href, Icon, color }) => (
                <motion.a
                  key={href}
                  href={href}
